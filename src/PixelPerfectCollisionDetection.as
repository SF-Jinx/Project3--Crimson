package
{
	...
	public class PixelPerfectCollisionDetection
	{
		...
		public static function getCollisionRect(target1:Entity, target2:Entity, commonParent:DisplayObjectContainer, pixelPrecise:Boolean = false, tolerance:Number = 0):Rectangle
		{
			// get bounding boxes in common parent's coordinate space
			var rect1:Rectangle = new Rectangle(target1.x, target1.y, target1.width, target1.height);
			var rect2:Rectangle = new Rectangle(target2.x, target2.y, target2.width, target2.height);
